...
return [
    ...
    'connections' => [
        ...
        'beanstalkd'=> ['driver' => 'beanstalkd', 'host' => 'localhost', 'queue' => 'default', 'retry_after' => (int) env('BEANSTALKD_QUEUE_RETRY_AFTER', 90), 'block_for' => 0, 'after_commit' => false],
    ...
    'batching'    => ['database' => env('DB_BATCHES_CONNECTION'), 'table' => 'job_batches'],
    'failed'      => ['driver' => env('QUEUE_FAILED_DRIVER', 'database-uuids'), 'database' => env('DB_FAILED_JOBS_CONNECTION'), 'table' => 'failed_jobs'],
];
