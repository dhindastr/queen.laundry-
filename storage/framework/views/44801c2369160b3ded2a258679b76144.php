...
<a href="<?php echo e(route('admin.kurir.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.kurir*') ? 'active' : ''); ?>">
...
<a href="<?php echo e(route('admin.stok.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.stok*') ? 'active' : ''); ?>">
...
<a href="<?php echo e(route('admin.invoice.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.invoice*') ? 'active' : ''); ?>">
...
<?php /**PATH /Users/mac/Downloads/ql/resources/views/components/nav-admin.blade.php ENDPATH**/ ?>