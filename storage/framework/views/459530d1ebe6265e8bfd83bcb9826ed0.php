...
<nav class="nav">
  <div class="nav-inner">
    <a href="<?php echo e(route('landing')); ?>" class="nav-brand">
    ...
    <div class="nav-links">
      ...
      <a href="<?php echo e(route('register')); ?>" class="nav-btn">Daftar Gratis</a>
    </div>
  </div>
</nav>
  ...
  <div class="hero" style="max-width:none;padding:0;margin-top:60px">
    ...
    <div style="padding:60px 0 60px 32px">
      <div class="login-card">
        ...
        <div class="login-card-sub">Belum punya akun? <a href="<?php echo e(route('register')); ?>" style="color:var(--brand);font-weight:600;text-decoration:none">Daftar gratis</a></div>
  ...
  <div class="section-inner" style="text-align:center">
    ...
    <div class="price-grid">
      <div class="price-card">
        ...
        <a href="<?php echo e(route('register')); ?>" class="price-cta price-cta-outline">Mulai Sekarang</a>
      </div>
      <div class="price-card featured">
        ...
        <a href="<?php echo e(route('register')); ?>" class="price-cta price-cta-solid">Mulai Sekarang</a>
      </div>
      <div class="price-card">
  ...
  <div class="section-inner">
    ...
    <div class="testi-grid">
      <div class="testi-card">
        <div class="testi-stars"><?php for($i=0;$i<5;$i++): ?><svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg><?php endfor; ?></div>
...
<div class="cta-band">
  ...
  <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
    <a href="<?php echo e(route('register')); ?>" class="btn btn-white">
      <svg viewBox="0 0 24 24"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
      Daftar Gratis
    </a>
  ...
  <div class="footer-inner">
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="<?php echo e(route('register')); ?>">Daftar Customer</a></li>
          <li><a href="<?php echo e(route('login')); ?>">Halaman Login</a></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <span>© <?php echo e(date('Y')); ?> Queen Laundry. Semua hak dilindungi.</span>
...
<?php /**PATH /Users/mac/Downloads/ql/resources/views/landing.blade.php ENDPATH**/ ?>